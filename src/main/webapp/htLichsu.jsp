...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">	
	...
	<form class="navbar-form navbar-left" action="homeController" method="post">
      <div class="input-group">
        <input type="text" class="form-control" name="txttk" placeholder="Nhập để tìm kiếm">
        <div class="input-group-btn">
          <button class="btn btn-default" name="butdn" type="submit" value="Tìm kiếm">
            <i class="glyphicon glyphicon-search"></i>
          </button>
        </div>
      </div>
   ...
   for(lichSubean ls: ds){ %>
      ...
      <td><%=ls.getNgayMua() %></td>
      <td><%=(ls.isDaMua()?"Da thanh toan":"Dang dat mua") %></td>
   <% i++;} %>
   </table>
    <!-- Hết hiển thị lịch sử -->
