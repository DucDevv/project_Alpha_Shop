		...
		<td valign="top" width="200" >
   			...
   			<div class="card bg-light mb-3">
   				...
   				<%for(loaigiaybean l: dsloaigiay){%>
   					<tr>
   					<td>
   						<a href="homeController?mlg=<%=l.getMaloaigiay()%>">
   						<%=l.getTenloaigiay() %>
   						</a>
   					</td>
   					</tr>
   		...
   		<tr>
   			<td>
   				<a href="chitietSp.jsp"><img src="<%=s.getAnh()%>"></a> <br>
				<a href="chitietSp.jsp"><%=s.getTengiay() %></a> <br>
   				<%=s.getGia() %> <br>
   				<a href="giohangController?ms=<%=s.getMagiay()%>&ts=<%=s.getTengiay()%>&gia=<%=s.getGia()%>">  <img src="button-mua-ngay.gif" width="100"></a>
   			</td>
   			...
   			if(i<n){
   				s=dsgiay.get(i);%>
   				<td>
   					<a href="chitietSpController"><img src="<%=s.getAnh()%>"></a> <br>
					<a href="chitietSpController"><%=s.getTengiay() %></a> <br>
   					<%=s.getGia() %> <br>
   					<a href="giohangController?ms=<%=s.getMagiay()%>&ts=<%=s.getTengiay()%>&gia=<%=s.getGia()%>">  <img src="button-mua-ngay.gif" width="100"></a>
   				</td>
   				<%}%>
